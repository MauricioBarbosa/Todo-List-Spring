...
public class SessionControlExceptionHandlerUnitTest {
    ...
    @BeforeEach
    void setUp() {
        this.sessionControlExceptionHandler =
            new SessionControlExceptionHandler();
    }
    ...
    void handleInvalidPasswordException_shouldReturnBadRequestWithMessage() {
        ...
        ResponseEntity<BadRequestOutput> response =
            sessionControlExceptionHandler.handleInvalidPassword(
                invalidPassword
            );
    ...
    void handleUserNotFoundException_shouldReturnBadRequestWithMessage() {
        ...
        ResponseEntity<BadRequestOutput> response =
            sessionControlExceptionHandler.handleUserNotFoundException(
    ...
    void handleCouldNotRetrieveUser_shouldReturnInternalServerError() {
        ...
        ResponseEntity<Void> response =
            sessionControlExceptionHandler.handleCouldNotRetrieveUser(
    ...
    void handleCouldNotSaveSession_shouldReturnInternalServerError() {
        ...
        ResponseEntity<Void> response =
            sessionControlExceptionHandler.handleCouldNotSaveSession(
                couldNotSaveSession
            );
    ...
    void handleCouldNotGenerateToken_shouldReturnInternalServerError() {
        ...
        ResponseEntity<Void> response =
            sessionControlExceptionHandler.handleCouldNotGenerateToken(
    ...
    void handleCouldNotDecodeToken_shouldReturnInternalServerError() {
        ...
        ResponseEntity<Void> response =
            sessionControlExceptionHandler.handleCouldNotDecodeToken(
                couldNotDecodeToken
            );
    ...
    void handleSessionNotFound_shouldReturnInternalServerError() {
        ...
        ResponseEntity<UnauthorizedOutput> response =
            sessionControlExceptionHandler.handleSessionNotFound(
                sessionNotFound
            );
    ...
    void couldNotFindSession_shouldReturnInternalServerError() {
        ...
        ResponseEntity<Void> response =
            sessionControlExceptionHandler.handleCouldNotFindSession(
                couldNotFindSession
            );
    ...
    void couldConfirmationCodeIsNotEqualToSessionConfirmationCode_shouldReturnBadRequestWithMessage() {
        ...
        ResponseEntity<BadRequestOutput> response =
            sessionControlExceptionHandler.handleConfirmationCodeIsNotEqualToSessionConfirmationCode(
