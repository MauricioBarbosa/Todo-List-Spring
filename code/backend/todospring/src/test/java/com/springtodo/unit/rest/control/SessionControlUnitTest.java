...
public class SessionControlUnitTest {
        ...
        class TestPostLogin {
                ...
                void shouldThrowUserNotFoundException()
                        ...
                        UserNotFoundException couldNotRetrieveUser = new UserNotFoundException("user not found");

                        when(
                                        startUserSessionUseCase.execute(any(StartUserSessionInput.class)))
                ...
                void shouldThrowCouldNotGenerateToken()
                        ...
                        CouldNotGenerateToken couldNotSaveSession = new CouldNotGenerateToken(
                ...
                void shouldReturnAResponseEntityWithToken()
                        ...
                        startSessionOutput.setSessionToken("someSessionToken");
